...
@TeleOp(name="OneAnalogControl", group="AnalogControlByRoba") //Calls this class (program) a teleop so it can be run at the driver station.
//@Disabled  //Disables this script from showing up in the driver station.

public class OneAnalogControl extends OpMode {  //Basic class where the code runs and extends this to the Opmode procedures.
