...
@TeleOp(name="TwoAnalogControlByRoba", group="AnalogControlByRoba") //Calls this class (program) a teleop so it can be run at the driver station.
//@Disabled  //Disables this script from showing up in the driver station.

public class TwoAnalogControlByRoba extends OpMode {
